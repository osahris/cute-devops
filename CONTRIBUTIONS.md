...
- **Alexander Hirsch** — Institute for Digital Medicine and Clinical Data Science, Goethe University Frankfurt
- **Andreas Streichardt**
- **Philipp Kaluza**

## AI coding support

Parts of the code and documentation were created with the help of AI coding assistants: GitHub Copilot, OpenAI ChatGPT, and Anthropic Claude.
